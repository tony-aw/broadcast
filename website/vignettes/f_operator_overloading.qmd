...
Most notably, the broadcasted operators do not preserve attributes, except names and the `broadcaster` class attribute.  
...
Some class specific attributes, for example, may be related to dimensions or length.  
For example, custom matrix classes presumes the object to have 2 dimensions, and the various classes from the 'bit' package use length-related attributes for their functionality.    
