...
'broadcast' provides the [bcapply()](/man/bcapply.qmd) and [bc_ifelse()](/man/bc_ifelse.qmd) functions, which are broadcasted apply-like and ifelse-like functions, respectively.
