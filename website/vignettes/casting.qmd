...
It is trivially easy to set the `dimnames` of `x2`, using [hiernames2dimnames()](/man/hier2dim.qmd) (available from version `0.1.5`):
...
# Data Wrangling Example: Turning list inside out
