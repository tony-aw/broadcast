...
For the purposes of broadcasting, the reader may consider any pair arrays, `x` and `y`, to be "orthogonal" if **all** of the following holds for that pair of arrays:  
