...
"orthogonal" is a term that can mean a great many things; this section therefore explains what "orthogonal" is meant in the context of broadcasting.

Consider a row-vector `x` and column-vector `y`:
