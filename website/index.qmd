...
<!-- badges: start -->
<p align="center">
`r badge_github_actions("tony-aw/broadcast")` `r badge_repostatus("Active")` `r badge_custom("Author", "Tony Wilkes", "red")` `r badge_custom("ORCID", "0000-0001-9498-8379", "green", "https://orcid.org/0000-0001-9498-8379")` `r badge_cran_release("broadcast")` [![Dependencies](https://tinyverse.netlify.app/badge/broadcast)](https://cran.r-project.org/package=broadcast)   
</p>
<!-- badges: end -->
...
'broadcast' is an efficient 'C'/'C++' - based `r fa("r-project")` package that, as the name suggests, performs "broadcasting" (similar to broadcasting in the 'Numpy' module for 'Python').
...
Please read the [Broadcasting explained](https://tony-aw.github.io/broadcast/vignettes/d_broadcasting_explained.html) page for more details on "broadcasting".
...
... but this becomes an issue when `x` and/or `y` become very large, as the above operation involves replicating `y` several times - which costs memory, reduces speed, and the code is not easily scalable for arrays with different dimensions.
