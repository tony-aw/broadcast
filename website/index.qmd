...
Additionally, 'broadcast' includes the [acast()](/man/bc.b.qmd) function, for casting/pivoting an array into a new dimension. Roughly analogous to `data.table::dcast()`, but for arrays.
