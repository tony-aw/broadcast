...
These alternatives all need access to a different programming language, which brings with it a host of problems:
 ...
 - **Access to CRAN's quality control**:  `r fa("r-project")` is unique in that it has access to CRAN's quality control; most other languages (including Python) don't have a real comparable organization like CRAN.
