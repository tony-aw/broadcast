...
Other `r fa("r-project")` packages that share this philosophy include, but are not limited to, the following:
 ...
 - [tinytest](https://github.com/markvanderloo/tinytest) for unit testing. Unlike 'testthat' (which has like a quadrillion dependencies), 'tinytest' has zero dependencies.
