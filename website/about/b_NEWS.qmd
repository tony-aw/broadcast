...
NOTE: CRAN is on holiday from 2026-08-5 until 2026-08-19, so the broadcast package will updated on CRAN on 2026-08-20.
...
* The `direction` argument in the [vector2array()](/man/vector2array.qmd) function has been replaced with the `orient` argument.
* The [vector2array()](/man/vector2array.qmd) function now gives a proper error if a vector longer than `2^31 -1` is given.
* Improved safety checks for the [mbroadcasters()](/man/broadcaster.qmd) function.
