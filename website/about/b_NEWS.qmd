...
# broadcast 0.1.7 (Under Development)
...
* Most methods and operators now also preserve `comment` attributes.
* [bcapply()](/man/bcapply.qmd) will now accept the argument input `v = "numeric"` as an alias for `v = "double"`.
