...
After pre-processing, the "dimensional mode" of the simplified arrays is determined. The following modes are available:
 ...
 - Vector mode: This mode is used when one or both of the arrays are actually vectors or 1d arrays. It is also used when no broadcasting needs to occur.
 - General mode: This mode is used for general broadcasting, that cannot be simplified to the vector mode.
