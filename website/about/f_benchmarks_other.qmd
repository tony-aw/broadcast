...
On this page, the performance of the [bind_array()](/man/bind.qmd) function from 'broadcast' is compared to the performance of the `abind()` function from the 'abind' package.
