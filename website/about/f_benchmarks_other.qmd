...
This page benchmarks some of the functions from 'broadcast' with some near-equivalent functions from base `r fa("r-project")` and other packages. The code is given here also.
...
In this section, the performance of the [bind_array()](/man/bind_array.qmd) function from 'broadcast' is compared to the performance of the `abind()` function from the 'abind' package.
