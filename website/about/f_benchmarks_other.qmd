...
This page benchmarks some of the functions from the latest version (0.1.6) of 'broadcast' with some near-equivalent functions from base `r fa("r-project")` and other packages. The code is given here also.
