...
<ul>
<li> [bc.b](rep_dim.qmd): Boolean (i.e. logical) operations;

</li>
<li> [bc.i](broadcaster.qmd): integer arithmetic and relational operations;

</li>
<li> [bc.d](typecast.qmd): decimal arithmetic and relational operations;

</li>
<li> [bc.cplx](typecast.qmd): complex arithmetic and (in)equality operations;

</li>
<li> [bc.str](typecast.qmd): string (in)equality, concatenation, and distance operations;

</li>
<li> [bc.raw](typecast.qmd): byte- and relational operations for vectors/arrays of type <code>raw</code>;

</li>
<li> [bc.bit](ndim.qmd): BIT-WISE operations, supporting the <code>raw</code> and <code>integer</code> types;

</li>
<li> [bc.list](typecast.qmd): apply any 'R' function to 2 recursive arrays with broadcasting. <br /> <br />

</li></ul>

<b><code>bind_array()</code></b> <br />
'broadcast' provides the [bind_array](broadcaster.qmd) function,
...
<ul>
<li> [bc_ifelse](bc.bit.qmd): Broadcasted version of ifelse.

</li>
<li> [bcapply](bc.cplx.qmd): Broadcasted apply-like function. <br /> <br />

</li></ul>

<b>Other functions</b> <br />
'broadcast' provides the [acast](bc.b.qmd) function,
...
To that end, the 'broadcast' package provides the [broadcaster](typecast.qmd) class,
