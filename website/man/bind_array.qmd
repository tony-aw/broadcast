...
Specifying <code>along = N + 1</code>, with <code style="white-space: pre;">N = max(</code>[lst.ndim](ndim.qmd)<code style="white-space: pre;">(input))</code>,
...
with <code style="white-space: pre;">N = max(</code>[lst.ndim](ndim.qmd)<code style="white-space: pre;">(input))</code>.
</td></tr>
