...
The <code>bc_ifelse()</code> S4 generic method
...
Recursive arrays of type <code>list</code> are also supported. <br />
since <code>bc_ifelse()</code> is an S4 generic, it can be extended to support special array classes. <br />
</td></tr>
</table>
