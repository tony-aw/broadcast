...
<td>
<code>logical</code> vector or array with the length equal to <code style="white-space: pre;">prod(</code>[bc_dim](bc_dim.qmd)<code style="white-space: pre;">(yes, no))</code>.
</td></tr>
