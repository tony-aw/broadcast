...
# [![](man/figures/logo.png){width="250"}](https://github.com/tony-aw/broadcast)
...
For example:  
Suppose you want to compute some metric on all possible pair-wise combinations of the elements of 2 vectors.  
