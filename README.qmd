<p align="center"><img src="man/figures/broadcast.png" height="300"/></p>
...
<p align="center"> Simple 'Numpy'-like Broadcasted Operations for Atomic and Recursive Arrays with Minimal Dependencies in 'R' </p>

<!-- badges: start -->

<p align="center"> `r badge_repostatus("WIP")` `r badge_lifecycle("experimental")` `r badge_custom("ORCID", "0000-0001-9498-8379", "green", "https://orcid.org/0000-0001-9498-8379")` </p>
...
-   About: Contains the Acknowledgements, Change logs and License file. Here you'll also find some information regarding the relationship between 'broadcast' and other 'R' packages.
