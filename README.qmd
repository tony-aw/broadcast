...
2.  The `bind_array()` function for binding arrays along any arbitrary dimension. Similar to the fantastic `abind::abind()` function, but faster, more memory-efficient, supporting broadcasting, and supporting both atomic and recursive arrays.
